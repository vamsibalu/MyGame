package bala{
	...
	public class BodyContacts extends b2ContactListener {
		...
		public var real_point:Point = new Point();
		...
		override public function BeginContact(contact:b2Contact):void {
			...
			if (((mc1&&mc2)&&game)) {
				...
				//var body:b2Body=b1;//this is the body you are considering
				
				//its either bodyA or bodyB, in this example it's bodyA as i assume here that it's a metal barrel
				
				real_point.x=b1.GetWorldPoint(contact_point).x*BaseWorld.ptm_ratio;
				real_point.y=b1.GetWorldPoint(contact_point).y*BaseWorld.ptm_ratio;
				// you can also play sounds in here! good luck.
				
				trace("tuching point=",game.bykeOnFloor,contact_point.x.toFixed(1))*/
			}
